...
<div class="box">
    <div class="box-header">
        ...
        <a href="<?php echo base_url(); ?>menu/parent_menu" class="btn bg-yellow btn-flat margin">Kembali</a>
    </div>
    <div class="box-body">
        <form id="checkform">
            ...
            <table id="list" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a class="btn bg-maroon btn-flat" href="<?php echo base_url(); ?>menu/delete_level_menu/<?php echo $dt->id_trans_menu_level; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')" title="Hapus">
...
<div class="modal fade" id="tambah-kategori">
    <div class="modal-dialog">
        <!-- form start -->
        <form role="form" method="POST" action="<?php echo base_url(); ?>menu/save_level_menu">
