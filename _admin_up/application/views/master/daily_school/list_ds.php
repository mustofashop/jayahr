...
function Edit(ID){
	...
	$.ajax({
		type	: "POST",
		url		: "<?php echo site_url(); ?>/master/edit_ds",
		data	: "cari="+cari,
		dataType: "json",
...
<div class="box">
    <div class='box-header'>
        ...
        <a class="btn btn-app" href="<?php echo base_url(); ?>master/delete_ds_all/<?php echo $bulan; ?>/<?php echo $userid; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')" title="Hapus"><i class="fa fa-trash"></i>Hapus Semua</a> 
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a class="btn bg-olive btn-flat" href="#modals" onclick="javascript:Edit('<?php echo $dt->id;?>')" data-toggle="modal" title="Edit">
                        ...
                        <a class="btn bg-maroon btn-flat" href="<?php echo base_url(); ?>master/delete_ds/<?php echo $dt->id; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')" title="Hapus">
...
<div class="modal fade" id="modals">
    <div class="modal-dialog">
        <!-- form start -->
        <form role="form" method="POST" action="<?php echo base_url(); ?>master/save_ds">
...
<div class="modal fade" id="modal-excel">
    <div class="modal-dialog">
        <!-- form start -->
        <form role="form" method="POST" action="<?php echo base_url(); ?>master/upload_ds" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
