...
$(document).ready(function(){
    $('#nama').change(function(){ 
        var id  =   $("#nama").val();
        $.ajax({
            url         : "<?php echo site_url(); ?>master/get_nama_guru",
            type        : "POST",
            data        : "id="+id,
            cahce       : false,
            dataType    : 'json',
            success     : function(data){
                ...
                for(i = 0; i < data.length; i++){
                    html += '<option value='+data[i].userid+'>'+data[i].nama_guru+'</option>';
                }
                $('#guru').html(html);
            }
        });
...
<div class="row">
    <div class="col-md-6">
        ...
        <?php endif; ?>
        <div class="box">
            <form method="GET" action="<?php echo base_url(); ?>master/get_data_daily_office">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="guru" id="guru" class="form-control select2" style="width: 100%;">
