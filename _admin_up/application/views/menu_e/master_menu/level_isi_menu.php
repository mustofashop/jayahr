    ...
    <div class="col-md-6">
        ...
        <div class="box">
            <div class="box-header">
                ...
                <a class="btn btn-app margin" href="<?php echo base_url(); ?>menu_e/isi_menu_e/<?php echo $id_menu; ?>">
            ...
            <div class="box-body">
                <table class="table table-bordered table-striped tabeldinamis">
                    ...
                    <tbody>
                        <?php
                            $no     = 1;
                            $data   = $this->menu_e_model->list_level_isi_menu($id_menu); 
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn bg-red btn-flat" href="<?php echo base_url() ?>menu_e/delete_level_isi/<?php echo $dt->id_menu_level; ?>" title="delete level" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
...
<div class="modal fade" id="modal1">
    <div class="modal-dialog">
        <!-- form start -->
        <form role="form" method="POST" action="<?php echo base_url(); ?>menu_e/simpan_level_isi_menu" enctype="multipart/form-data">
