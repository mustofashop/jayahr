            ...
            <div class="box-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php if($dt->logo_yayasan == ""||empty($dt->logo_yayasan)){ ?>
                            <td class="center"><img class="editable" name="logo" id="logo" src="<?php echo base_url();?>assets/img/default-logo.png" width="100" height="100" /></td>
                        <?php }else{ ?>
                            <td class="center"><img class="editable" name="logo" id="logo" src="data:image/jpeg;base64,<?php echo $dt->logo_yayasan;?>" width="100" height="100" /></td>
                        <?php } ?>
                        <td>
...
<div class="modal fade" id="modal-parent">
    <div class="modal-dialog">
        <!-- form start -->
        <form role="form" method="POST" action="<?php echo base_url(); ?>users/save_admin_yayasan" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div>
                        <label for="image">Logo Yayasan</label>
                        <div class="col-md-12">
