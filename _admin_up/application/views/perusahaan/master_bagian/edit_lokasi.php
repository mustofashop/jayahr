            ...
            <div class="box-body">
                <table id="table" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                            $no     = '1';
                            $data   = $this->enterprise_model->get_lokasi_bagian($id_bagian);
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <!-- delete -->
                                    <a class="btn bg-maroon btn-flat" href="<?php echo base_url(); ?>perusahaan/delete_lokasi_bagian/<?php echo $dt->id_bagian_detail; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')" title="Hapus">
...
<div class="modal fade" id="modal">
    <div class="modal-dialog">
        <!-- form start -->
        <form role="form" method="POST" action="<?php echo base_url(); ?>perusahaan/save_lokasi_bagian" enctype="multipart/form-data">
