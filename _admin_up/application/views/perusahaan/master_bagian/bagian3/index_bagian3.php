...
function Edit(ID){
    ...
    $.ajax({
        type	: "POST",
        url		: "<?php echo site_url(); ?>/perusahaan/edit_bagian_3",
        data	: "cari="+cari,
        dataType: "json",
...
<div class="box">
    <div class="box-header">
        ...
        <a class="btn btn-app" href="<?php echo base_url(); ?>perusahaan/master_bagian_2/<?php echo $id_b ?>/<?php echo $id_p; ?>">
    ...
    <div class="box-body">
        <table id="table" class="table table-bordered table-striped">
            ...
            <tbody>
                <?php
                    $no     = 1;
                    $data   = $this->enterprise_model->list_bagian_lvl_3($id_b2);
                    foreach($data->result() as $dt){
                ?>
                    <tr>
                        <td><?php echo $no; ?></td>
                        <td><?php echo $dt->id_bagian_3; ?></td>
                        <td><?php echo $dt->nama_bagian_3; ?></td>
                        <td>
                            <?php
                                $lead   = $this->enterprise_model->nama_leader3($dt->id_bagian_3);
                        ...
                        <td>
                            <!-- edit -->
                            <a class="btn bg-olive btn-flat" href="#modals" onclick="javascript:Edit('<?php echo $dt->id_bagian_3;?>')" data-toggle="modal" title="Edit">
                                <i class="fa fa-pencil"></i>
                            </a>
                            <!-- bagian level 4 -->
                            <a class="btn bg-blue btn-flat" href="<?php echo base_url(); ?>perusahaan/master_bagian_4/<?php echo $dt->id_bagian_3 ?>/<?php echo $id_b2; ?>/<?php echo $id_b; ?>/<?php echo $id_p; ?>" title="Bagian Level 4">
                                <i class="fa fa-plus"></i>
                            </a>
                            <!-- hapus -->
                            <a class="btn bg-maroon btn-flat" href="<?php echo base_url(); ?>perusahaan/delete_bagian_3/<?php echo $dt->id_bagian_3; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')" title="Hapus">
