...
function Edit(ID){
    ...
    $.ajax({
        type	: "POST",
        url		: "<?php echo site_url(); ?>/perusahaan/edit_inass",
        data	: "cari="+cari,
        dataType: "json",
...
<div class="box">
    <div class="box-header">
        <h3 class="box-title">List Pertanyaan Level 1</h3>
    ...
    <div class="box-body">
        <table id="table" class="table table-bordered table-striped">
            ...
            <tbody>
                <?php
                    $no     = '1';
                    $data   = $this->enterprise_model->get_inass();
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <!-- edit -->
                            <a class="btn bg-olive btn-flat" href="#edit" onclick="javascript:Edit('<?php echo $dt->id_iass;?>')" data-toggle="modal" title="Edit">
                                <i class="fa fa-pencil"></i>
                            </a>
                            <!-- bagian level 2 -->
                            <a class="btn bg-blue btn-flat" href="<?php echo base_url(); ?>perusahaan/master_inass_2/<?php echo $dt->id_iass; ?>/<?php echo $id_p; ?>" title="Level 2">
                                <i class="fa fa-plus"></i>
                            </a>
                            
                            <!-- delete -->
                            <a class="btn bg-maroon btn-flat" href="<?php echo base_url(); ?>perusahaan/delete_inass/<?php echo $dt->id_iass; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')" title="Hapus">
...
<div class="modal fade" id="edit">
    <div class="modal-dialog">
        <form role="form" method="POST" action="<?php echo base_url(); ?>perusahaan/save_edit_inass">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="id_iass" id="id_iass">
                    </div>
					<div class="form-group">
...
<div class="modal fade" id="modal">
    <div class="modal-dialog">
        <!-- form start -->
        <form role="form" method="POST" action="<?php echo base_url(); ?>perusahaan/save_inass" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
