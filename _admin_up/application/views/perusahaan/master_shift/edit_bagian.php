            ...
            <div class="box-body">
                <table class="table table-bordered table-striped tabeldinamis">
                    ...
                    <tbody>
                        <?php
                            $no             = '1';
                            $list_bagian    = $this->enterprise_model->list_bagian_shift($id_shift);
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <!-- delete -->
                                    <a class="btn bg-maroon btn-flat" href="<?php echo base_url(); ?>perusahaan/delete_bagian_shift/<?php echo $lb->id_shift_bagian; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')" title="Hapus">
...
<div class="modal fade" id="modal">
    <div class="modal-dialog">
        <!-- form start -->
        <form role="form" method="POST" action="<?php echo base_url(); ?>perusahaan/simpan_bagian_shift" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select class="form-control select2" multiple="multiple" name="bagian[]" style="width: 100%;" id="bagian" required="required">
                            <?php
                                $list_shift_bagian = $this->enterprise_model->list_shift_bagian_check($id_shift,$id_p);
