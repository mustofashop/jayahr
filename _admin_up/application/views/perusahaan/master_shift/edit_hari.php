            ...
            <div class="box-body">
                <table class="table table-bordered table-striped tabeldinamis">
                    ...
                    <tbody>
                        <?php
                            $no         = '1';
                            $list_hari  = $this->enterprise_model->list_hari_shift($id_shift);
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <!-- delete -->
                                    <a class="btn bg-maroon btn-flat" href="<?php echo base_url(); ?>perusahaan/delete_hari_shift/<?php echo $lh->id_shift; ?>/<?php echo $lh->hari; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')" title="Hapus">
...
<div class="modal fade" id="modal">
    <div class="modal-dialog">
        <!-- form start -->
        <form role="form" method="POST" action="<?php echo base_url(); ?>perusahaan/simpan_hari_shift" enctype="multipart/form-data">
