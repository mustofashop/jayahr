...
class Lap_idp extends CI_Controller
{
    ...
    public function list_idp()
    {
        ...
        if ($masuk != TRUE) {
            ...
            $d['header']    = 'Laporan Pengisian IDP';
            $d['content']   = 'laporan/idp/list_member';
    ...
    public function rekap_idp()
    {
        ...
        if ($masuk != TRUE) {
            ...
            $d['unit2']     = $unit2;
            $d['class']     = '';
            $d['header']    = 'Rekap IDP (Pilih Tahun & Unit)';
            $d['content']   = 'laporan/idp/frekap_idp';
            $this->load->view('master', $d);
        }
    }
}
