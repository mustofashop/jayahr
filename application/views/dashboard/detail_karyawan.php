<div class="box">
    <?php 
        $data_karyawan = $this->master_model->detail_karyawan_full($id_karyawan); 
        foreach($data_karyawan->result() as $dt){
    ?>
    <div class="box-header">
        <a class="btn btn-app" href="<?php echo base_url(); ?>dashboard/list_karyawan/<?php echo $id_lokasi; ?>">
                        ...
                        <div class="box">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nip" id="nip" class="form-control" placeholder="0" value="<?php echo $dt->nip; ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tempat_lahir" id="tempat_l" class="form-control" value="<?php echo $dt->tempat_lahir; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            ?>
                                            <input type="text" class="form-control tanggal" name="tanggal_lahir" id="tanggal_l" data-date-format="dd-mm-yyyy" autocomplete="off" value="<?php echo $tanggal; ?>">
                                        </div>
                                    </div>
                                </div>
                                <!-- end row -->
