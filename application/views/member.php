...
<head>
  ...
  <title>Jaya HR Application | <?php echo $header; ?></title>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
  <!-- bootstrap horizon -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/bower_components/bootstrap-horizon/src/bootstrap-horizon.css">
  <!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini">E<b>N</b>T</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">JAYA <b>HR Application</b></span>
    </a>
