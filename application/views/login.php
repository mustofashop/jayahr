...
<head>
  ...
  <title>Jaya HR Application | Log in</title>
...
<body class="hold-transition login-page">
  <div class="login-box" style="margin:1% auto;">
    ...
    <!-- <a href="<?php echo base_url();?>assets/index2.html">Template <b>PHP</b>7</a> -->
    <img src="<?php echo base_url(); ?>assets/img/oase.png" alt="" style="width:50%;">
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url();?>login/masuk" method="post">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="no_telepon" placeholder="NRP" required="required">
      ...
      <!--
	  <div class="form-group has-feedback">
        <input type="number" class="form-control" name="ip" placeholder="IP Perusahaan" required="required">
