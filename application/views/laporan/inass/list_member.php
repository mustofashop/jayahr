    ...
    <div class="box-body">
        ...
        <div class="tab-content">
            <div id="home" class="tab-pane fade in active">
				<!-- <a class="btn bg-green btn-flat margin" href="<?php echo base_url(); ?>lap_inass/download_inass_belum">
                ...
                <table class="table table-bordered table-striped tabeldinamis">
                    ...
                    <tbody>
                        <?php
                            ...
                            $thn = '2023';
							$data_1 = $this->master_model->list_inass_belum($thn);
                ...
                <table class="table table-bordered table-striped tabeldinamis">
                    ...
                    <tbody>
                        <?php
							...
							$nrp    = $this->session->userdata('nrp');
							$thn = '2023';
                            $data_1 = $this->master_model->list_inass_sudah($thn);
                            foreach($data_1->result() as $dt1){
								$tahun = 2023;
								//$cek_idp = $this->master_model->cek_idp($tahun,$dt1->nip);
								//$cek_fidp = $this->master_model->cek_sent_idp($tahun,$dt1->nip);
