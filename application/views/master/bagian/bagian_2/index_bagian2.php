...
function Edit(ID){
    ...
    $.ajax({
        type	: "POST",
        url		: "<?php echo site_url(); ?>/bagian/edit_bagian_2",
        data	: "cari="+cari,
        dataType: "json",
            ...
            <div class="box-body">
                <table class="table table-bordered table-striped tabeldinamis">
                    ...
                    <tbody>
                        <?php
                            $no     = 1;
                            $data   = $this->master_model->list_bagian_lvl_2($id_bagian);
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <?php
                                        $lead   = $this->master_model->nama_leader2($dt->id_bagian_2);
                                ...
                                <td>
                                    ...
                                    <?php } ?>
                                    <!-- bagian level 3 -->
                                    <a class="btn bg-blue btn-flat" href="<?php echo base_url(); ?>bagian/bagian_3/<?php echo $dt->id_bagian_2 ?>/<?php echo $id_bagian; ?>" title="Bagian Level 3 <?php echo $dt->nama_bagian_2; ?>">
                                        <i class="fa fa-plus"></i>
                                    </a>
                                </td>
                            </tr>
...
<div class="modal fade" id="modal">
    <div class="modal-dialog">
        <!-- form start -->
        <form role="form" method="POST" action="<?php echo base_url(); ?>bagian/simpan_bagian2" enctype="multipart/form-data">
