...
function Edit(ID){
    ...
    $.ajax({
        type	: "POST",
        url		: "<?php echo site_url(); ?>/bagian/edit_bagian_4",
        data	: "cari="+cari,
        dataType: "json",
    ...
    <div class="col-md-12">
        ...
        <div class="box">
            <div class="box-header">
                <a class="btn btn-app" href="<?php echo base_url(); ?>bagian/bagian_3/<?php echo $id_bagian2; ?>/<?php echo $id_bagian ?>">
            ...
            <div class="box-body">
                <table class="table table-bordered table-striped tabeldinamis">
                    ...
                    <tbody>
                        <?php
                            $no     = 1;
                            $data   = $this->master_model->list_bagian_lvl_4($id_bagian3);
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <?php
                                        $lead   = $this->master_model->nama_leader4($dt->id_bagian_4);
                                ...
                                <td>
                                    <!-- edit -->
                                    <?php if($aksi3 == '3'){ ?>
                                        <a class="btn bg-olive btn-flat" href="#modal" onclick="javascript:Edit('<?php echo $dt->id_bagian_4;?>')" data-toggle="modal" title="Edit">
...
<div class="modal fade" id="modal">
    <div class="modal-dialog">
        <!-- form start -->
        <form role="form" method="POST" action="<?php echo base_url(); ?>bagian/simpan_bagian4" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="id_bagian_3" value="<?php echo $id_bagian3; ?>">
                    </div>
                    <div class="form-group">
