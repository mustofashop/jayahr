...
<div class="box">
    <div class="box-header">
        <a class="btn btn-app" href="<?php echo base_url(); ?>m_education">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-flat bg-blue" href="<?php echo base_url(); ?>m_education/lihat_education/<?php echo $dt1->id_karyawan; ?>/<?php echo $kategori; ?>" title="Lihat <?php echo $dt1->nama_lengkap; ?>">
