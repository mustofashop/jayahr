								...
								<tbody>
									...
									?>
										<tr>
											...
											<?php
											$isi1 = $this->master_model->profile_idp_dtl($dt->nip, $dt1->tahun, $atasan, 1);
						...
						<div class="box">
							<table class="table table-bordered table-striped tabeldinamis">
								...
								<tbody>
									...
									$status = 0;
									$tahun = '2024';
									$data   		= $this->master_model->list_inass_rekap_score($dt->nip, $tahun, $atasan)->row();
									...
									?>
										<tr>
											...
											<td><?php echo $dt1->assesor; ?></td>
											<td><?php echo $row; ?></td>
											<td><?php echo number_format($data->inas2_2, 2, ',', '.'); ?></td>
											<td><?php echo number_format($data->inas2_3, 2, ',', '.'); ?></td>
											<td><?php echo number_format($data->inas2_4, 2, ',', '.'); ?></td>
											<td><?php echo number_format($data->inas2_5, 2, ',', '.'); ?></td>
											<td><?php echo number_format($data->inas2_6, 2, ',', '.'); ?></td>
											<td><?php echo number_format($data->isi_inass1, 2, ',', '.'); ?></td>
											<td><?php echo number_format($data->isi_inass11, 2, ',', '.'); ?></td>
