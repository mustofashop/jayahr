										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													?>
													<input type="text" class="form-control tanggal" name="tanggal_lahir" id="tanggal_l" placeholder="0001-01-01" data-date-format="yyyy-mm-dd" autocomplete="off" value="<?php echo $tanggal; ?>">
												</div>
											</div>
										</div>
										<div class="form-group">
