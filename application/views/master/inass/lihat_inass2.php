					...
					<div class="box-body">
						<div class="row">
							<div class="col-md-10">
								...
								$no     = '1';
								$id_iassx = 1;
								$data   = $this->master_model->list_isi_inass3($id_iassx, $nrp, $tahun, $atasan);
								foreach ($data->result() as $dt) {
								?>
									<div class="form-group">
										<label style="color:black" for=""><?php echo $dt->nama_value; ?></label>
										<input type="text" align="left" name="<?php echo 'iass3_' . $dt->id_iass_3; ?>" id="<?php echo 'iass3_' . $dt->id_iass_3; ?>" class="form-control" value="
					...
					<div class="box-body">
						<div class="row">
							<div class="col-md-10">
								...
								$no     = '1';
								$id_iassx = 2;
								$data   = $this->master_model->list_isi_inass2($id_iassx, $nrp, $tahun, $atasan);
								foreach ($data->result() as $dt) {
								?>
									<div class="form-group">
										<label style="color:black" for=""><?php echo $dt->nama_value; ?></label>
										<input type="text" align="left" name="<?php echo 'iass2_' . $dt->id_iass_2; ?>" id="<?php echo 'iass2_' . $dt->id_iass_2; ?>" class="form-control" value="
					...
					<div class="box-body">
						<div class="row">
							<div class="col-md-10">
								...
								$no     = '1';
								$id_iassx = 7;
								$data   = $this->master_model->list_isi_inass($id_iassx, $nrp, $tahun, $atasan);
								foreach ($data->result() as $dt) {
								?>
									<div class="form-group">
										<label style="color:black" for=""><?php echo $dt->nama_value; ?></label>
										<input type="text" align="left" name="<?php echo 'iass_' . $dt->id_iass; ?>" id="<?php echo 'iass_' . $dt->id_iass; ?>" class="form-control" value="
