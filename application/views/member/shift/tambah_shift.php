...
<?php endif; ?>
<div class="box">
    <form role="form" method="POST" action="<?php echo base_url(); ?>shift/simpan_shift" enctype="multipart/form-data">
                    ...
                    <div id="formsublokasi">
                        <div class="form-group">
                            ...
                            <select name="sublokasi[]" id="sublokasi" class="form-control select2" style="width:100%;" multiple="multiple">
                                <option value="">-- Pilih --</option>
                                <?php
                                    $sublokasi  = $this->master_model->list_sub_lokasi($id_p);
                    ...
                    <div id="formbagian">
                        <div class="form-group">
                            ...
                            <select name="bagian[]" id="bagian" class="form-control select2" style="width:100%;" multiple="multiple">
                                <option value="">-- Pilih --</option>
                                <?php
                                    $bagian  = $this->master_model->list_bagian($id_p);
