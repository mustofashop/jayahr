...
function Edit(ID){
    ...
    $.ajax({
        type	: "POST",
        url		: "<?php echo site_url(); ?>/shift/edit_detail",
        data	: "cari="+cari,
        dataType: "json",
    ...
    <div class="box-body">
        <table class="table table-bordered table-striped tabeldinamis">
            ...
            <tbody>
                <?php
                    $no     = '1';
                    $data   = $this->master_model->list_detail_shift($id_shift);
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- delete -->
                            <?php if($aksi4 == '4'){ ?>
                                <a class="btn bg-maroon btn-flat" href="<?php echo base_url(); ?>shift/delete_detail/<?php echo $dt->id_shift_detail; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')" title="Hapus">
...
<div class="modal fade" id="modal">
    <div class="modal-dialog modal-lg">
        <!-- form start -->
        <form role="form" method="POST" action="<?php echo base_url(); ?>shift/simpan_detail" enctype="multipart/form-data">
