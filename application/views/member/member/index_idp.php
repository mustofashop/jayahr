...
<div class="box">
    <div class="box-header">
        <a class="btn btn-app" href="<?php echo base_url(); ?>people_rev/idp?tahun=<?php echo $idp_tahun; ?>">
        ...
        <table id="table" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                foreach ($data->result() as $dt) {
                    ...
                    $cek_jwbn_idp = $this->master_model->cek_jawab_idp($idp_tahun, $dt->id_idp, $idp_nrp, $nrp);
                    ...
                    $nrp    = $this->session->userdata('nrp');
                    $cek_idp = $this->master_model->cek_idp_rekap($idp_tahun, $idp_nrp, $nrp);
                    $cek_fidp = $this->master_model->cek_sent_idp_rekap($idp_tahun, $idp_nrp, $nrp);
